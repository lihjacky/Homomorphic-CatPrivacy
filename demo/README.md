...
![Live demo — real FHE classification in the web UI](fhe-cat-demo.gif)
...
The standalone packages are right here in this directory:

| Package | What it does | Run on |
|---------|--------------|--------|
| [`fhe-crypto-tool-win64.zip`](fhe-crypto-tool-win64.zip) | key generation, encryption, decryption — everything sensitive, all local | Windows x64 |
| [`fhe-infer-tool-win64.zip`](fhe-infer-tool-win64.zip)  | ciphertext CNN inference | Windows x64 (localhost) **or** a real server |
| [`fhe-crypto-tool-linux-x64.tar.gz`](fhe-crypto-tool-linux-x64.tar.gz) | same crypto client + web UI | Linux x64 (glibc 2.36+) |
| [`fhe-infer-tool-linux-x64.tar.gz`](fhe-infer-tool-linux-x64.tar.gz)  | same inference server | Linux x64 (glibc 2.36+) |
...
[slides-126-hackathon-cat-privacy.pptx](slides-126-hackathon-cat-privacy.pptx)

## License

The distributed binaries are provided free of charge for evaluation and
research. See [`LICENSE.txt`](LICENSE.txt) and the bundled third-party notices.
